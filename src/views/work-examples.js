...
const WorkExamples = (props) => {
  return (
    <div className="work-examples-container">
      <Helmet>
        <title>Work-Examples - Togthr template</title>
        <meta property="og:title" content="Work-Examples - Togthr template" />
      </Helmet>
      <section className="work-examples-hero">
        ...
        <header data-role="Header" className="work-examples-header">
          ...
          <div className="work-examples-btn-group">
          ...
          >
            ...
            >
              ...
              <div className="work-examples-container3">
                <button className="work-examples-login1 button">Login</button>
                <button className="button">Register</button>
              </div>
            </div>
