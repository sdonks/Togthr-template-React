...
const Page = (props) => {
  return (
    <div className="page-container">
      <Helmet>
        <title>Page - Moview Productions | Stefan Doncean</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Page - Moview Productions | Stefan Doncean"
        />
        <meta
          ...
          <div className="page-nav1">
            <div className="page-container1">
              <img
                ...
                className="page-image01"
              />
              <div data-role="CloseMobileMenu" className="page-menu-close">
                <svg viewBox="0 0 1024 1024" className="page-icon02">
                  <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                </svg>
              </div>
            </div>
            <NavigationLinks1 rootClassName="rootClassName21"></NavigationLinks1>
          </div>
          <div>
      ...
      <section className="page-hero">
        ...
        <header data-thq="thq-navbar" className="page-navbar">
          ...
          />
          <div data-thq="thq-burger-menu" className="page-burger-menu1">
          ...
          <div data-thq="thq-mobile-menu" className="page-mobile-menu1">
            <div
            ...
            >
              <div className="page-container2">
                <img
                  ...
                  className="page-image02"
                />
                <div data-thq="thq-close-menu" className="page-menu-close1">
                  <svg viewBox="0 0 1024 1024" className="page-icon11">
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              ...
              >
                ...
                <span className="page-text001">Features</span>
                <span className="page-text002">Pricing</span>
                <span className="page-text003">Team</span>
                <span className="page-text004">Blog</span>
              </nav>
            ...
            <div className="page-icon-group1">
              <svg viewBox="0 0 950.8571428571428 1024" className="page-icon13">
                <path d="M925.714 233.143c-25.143 36.571-56.571 69.143-92.571 95.429 0.571 8 0.571 16 0.571 24 0 244-185.714 525.143-525.143 525.143-104.571 0-201.714-30.286-283.429-82.857 14.857 1.714 29.143 2.286 44.571 2.286 86.286 0 165.714-29.143 229.143-78.857-81.143-1.714-149.143-54.857-172.571-128 11.429 1.714 22.857 2.857 34.857 2.857 16.571 0 33.143-2.286 48.571-6.286-84.571-17.143-148-91.429-148-181.143v-2.286c24.571 13.714 53.143 22.286 83.429 23.429-49.714-33.143-82.286-89.714-82.286-153.714 0-34.286 9.143-65.714 25.143-93.143 90.857 112 227.429 185.143 380.571 193.143-2.857-13.714-4.571-28-4.571-42.286 0-101.714 82.286-184.571 184.571-184.571 53.143 0 101.143 22.286 134.857 58.286 41.714-8 81.714-23.429 117.143-44.571-13.714 42.857-42.857 78.857-81.143 101.714 37.143-4 73.143-14.286 106.286-28.571z"></path>
              </svg>
              <svg viewBox="0 0 877.7142857142857 1024" className="page-icon15">
                <path d="M585.143 512c0-80.571-65.714-146.286-146.286-146.286s-146.286 65.714-146.286 146.286 65.714 146.286 146.286 146.286 146.286-65.714 146.286-146.286zM664 512c0 124.571-100.571 225.143-225.143 225.143s-225.143-100.571-225.143-225.143 100.571-225.143 225.143-225.143 225.143 100.571 225.143 225.143zM725.714 277.714c0 29.143-23.429 52.571-52.571 52.571s-52.571-23.429-52.571-52.571 23.429-52.571 52.571-52.571 52.571 23.429 52.571 52.571zM438.857 152c-64 0-201.143-5.143-258.857 17.714-20 8-34.857 17.714-50.286 33.143s-25.143 30.286-33.143 50.286c-22.857 57.714-17.714 194.857-17.714 258.857s-5.143 201.143 17.714 258.857c8 20 17.714 34.857 33.143 50.286s30.286 25.143 50.286 33.143c57.714 22.857 194.857 17.714 258.857 17.714s201.143 5.143 258.857-17.714c20-8 34.857-17.714 50.286-33.143s25.143-30.286 33.143-50.286c22.857-57.714 17.714-194.857 17.714-258.857s5.143-201.143-17.714-258.857c-8-20-17.714-34.857-33.143-50.286s-30.286-25.143-50.286-33.143c-57.714-22.857-194.857-17.714-258.857-17.714zM877.714 512c0 60.571 0.571 120.571-2.857 181.143-3.429 70.286-19.429 132.571-70.857 184s-113.714 67.429-184 70.857c-60.571 3.429-120.571 2.857-181.143 2.857s-120.571 0.571-181.143-2.857c-70.286-3.429-132.571-19.429-184-70.857s-67.429-113.714-70.857-184c-3.429-60.571-2.857-120.571-2.857-181.143s-0.571-120.571 2.857-181.143c3.429-70.286 19.429-132.571 70.857-184s113.714-67.429 184-70.857c60.571-3.429 120.571-2.857 181.143-2.857s120.571-0.571 181.143 2.857c70.286 3.429 132.571 19.429 184 70.857s67.429 113.714 70.857 184c3.429 60.571 2.857 120.571 2.857 181.143z"></path>
              </svg>
              <svg viewBox="0 0 602.2582857142856 1024" className="page-icon17">
                <path d="M548 6.857v150.857h-89.714c-70.286 0-83.429 33.714-83.429 82.286v108h167.429l-22.286 169.143h-145.143v433.714h-174.857v-433.714h-145.714v-169.143h145.714v-124.571c0-144.571 88.571-223.429 217.714-223.429 61.714 0 114.857 4.571 130.286 6.857z"></path>
              </svg>
            </div>
          </div>
          ...
          <div className="page-header-container">
            <div className="page-header01">
              <h1 className="page-heading">
                ...
                <span className="page-text006">imagination</span>
                <br></br>
              </h1>
            </div>
      ...
      <section className="page-note">
        <h2 className="page-caption01">
          <span className="page-text011">
            Get noticed with &quot;Scroll Stopping&quot; Video Content!
          </span>
          <br></br>
          <br className="page-text013"></br>
          <span className="page-text014">
      ...
      <section className="page-slider">
        <div className="page-header02">
          <h2 className="page-heading01">
            ...
            <span className="page-text016">something</span>
            <span className="page-text017">
              .
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
        ...
        <div className="page-selector">
          <p className="page-caption02">
            <span className="page-text018">
              The highest status people in human history are those that asked
              for nothing and gave everything.
            </span>
            <br className="page-text019"></br>
            <br className="page-text020"></br>
          </p>
          <div className="page-slide-titles">
      ...
      <section className="page-statistics">
        <div className="page-content">
          <div className="page-stat">
            <h3 className="page-header03">Ultra-fast turnaround</h3>
          </div>
          <div className="page-stat1">
            <h3 className="page-header04">Stress-free experience</h3>
          </div>
          <div className="page-stat2">
            <h3 className="page-header05">Trusted service</h3>
          </div>
        </div>
      </section>
      <section className="page-slides">
        <div className="page-slider1 slider blaze-slider">
          <div className="page-slider-container blaze-container">
            <div className="page-slider-track-container blaze-track-container">
              <div className="page-slider-track blaze-track">
                <div data-role="current-banner" className="banner">
                  <img
                    alt="image"
                    src="/playground_assets/slider-ecosystems-400h.png"
                    className="page-image03"
                  />
                  <div className="page-content01">
                    <div className="page-header06">
                      <h3 className="page-heading02">Metaverse</h3>
                      <p className="page-caption03">
                    ...
                    <div className="page-more">
                      <span className="page-caption04">Read More</span>
                      <svg viewBox="0 0 1024 1024" className="page-icon19">
                ...
                <div data-role="current-banner" className="banner">
                  <img
                    alt="image"
                    src="/playground_assets/slider-ecosystems-400h.png"
                    className="page-image04"
                  />
                  <div className="page-content02">
                    <div className="page-header07">
                      <h3 className="page-heading03">Ecosystems</h3>
                      <p className="page-caption05">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua.
                        <span
                    ...
                    <div className="page-more1">
                      <span className="page-caption06">Read More</span>
                      <svg viewBox="0 0 1024 1024" className="page-icon21">
                        <path d="M298.667 341.333h323.669l-353.835 353.835c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0l353.835-353.835v323.669c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-426.667c0-5.803-1.152-11.307-3.243-16.341s-5.163-9.728-9.216-13.781c-0.043-0.043-0.043-0.043-0.085-0.085-3.925-3.925-8.619-7.083-13.781-9.216-5.035-2.091-10.539-3.243-16.341-3.243h-426.667c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                      </svg>
                    </div>
                  </div>
                ...
                <div data-role="current-banner" className="banner">
                  <img
                    alt="image"
                    src="/playground_assets/slider-ecosystems-400h.png"
                    className="page-image05"
                  />
                  <div className="page-content03">
                    <div className="page-header08">
                      <h3 className="page-heading04">Development</h3>
                      <p className="page-caption07">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua.
                        <span
                    ...
                    <div className="page-more2">
                      <span className="page-caption08">Read More</span>
                      <svg viewBox="0 0 1024 1024" className="page-icon23">
                        <path d="M298.667 341.333h323.669l-353.835 353.835c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0l353.835-353.835v323.669c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-426.667c0-5.803-1.152-11.307-3.243-16.341s-5.163-9.728-9.216-13.781c-0.043-0.043-0.043-0.043-0.085-0.085-3.925-3.925-8.619-7.083-13.781-9.216-5.035-2.091-10.539-3.243-16.341-3.243h-426.667c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                      </svg>
                    </div>
                  </div>
                ...
                <div data-role="current-banner" className="banner">
                  <img
                    alt="image"
                    src="/playground_assets/slider-ecosystems-400h.png"
                    className="page-image06"
                  />
                  <div className="page-content04">
                    <div className="page-header09">
                      <h3 className="page-heading05">Integration</h3>
                      <p className="page-caption09">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua.
                        <span
                    ...
                    <div className="page-more3">
                      <span className="page-caption10">Read More</span>
                      <svg viewBox="0 0 1024 1024" className="page-icon25">
                        <path d="M298.667 341.333h323.669l-353.835 353.835c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0l353.835-353.835v323.669c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-426.667c0-5.803-1.152-11.307-3.243-16.341s-5.163-9.728-9.216-13.781c-0.043-0.043-0.043-0.043-0.085-0.085-3.925-3.925-8.619-7.083-13.781-9.216-5.035-2.091-10.539-3.243-16.341-3.243h-426.667c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                      </svg>
                    </div>
                  </div>
            ...
            <div className="page-controls">
              <button
                ...
                className="page-previous blaze-prev button"
              >
                <svg viewBox="0 0 1024 1024" className="page-icon27">
                  <path d="M542.165 780.501l-225.835-225.835h494.336c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-494.336l225.835-225.835c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0l-298.667 298.667c-4.096 4.096-7.168 8.789-9.259 13.824-2.176 5.205-3.243 10.795-3.243 16.341 0 10.923 4.181 21.845 12.501 30.165l298.667 298.667c16.683 16.683 43.691 16.683 60.331 0s16.683-43.691 0-60.331z"></path>
                </svg>
              </button>
              <button
                data-role="next-banner-button"
                className="page-next blaze-next button"
              >
                <svg viewBox="0 0 1024 1024" className="page-icon29">
  ...
  all: {
    ...
    enableAutoplay: true,
      ...
      <section className="page-get-started">
        <div className="page-header-container1">
          <div className="page-header10">
            <h2 className="page-heading06">
        ...
        <img
          ...
          className="page-image07"
        />
      </section>
      <h2 className="page-heading07">
        <span>
        ...
        <span className="page-text027">production process.</span>
        <br></br>
      </h2>
      <section className="page-objectives">
        <div className="page-content05">
          <span className="page-text029">Objectives</span>
          <div className="page-objectives-list">
            <div className="objective">
              <h3 className="page-text030">Dream it</h3>
              <p className="page-text031">
                <span>
            ...
            <div className="objective page-objective1">
              <h3 className="page-text035">Capture it</h3>
              <p className="page-text036">
                <span>
            ...
            <div className="objective page-objective2">
              <h3 className="page-text041">Create it</h3>
              <p className="page-text042">
                <span>
      ...
      <section className="page-growth">
        <div className="page-content06">
          <div className="page-header11">
            <div className="page-header12">
              <h2 className="page-heading08">
                We guarantee you&apos;ll love your video or your money back*.
              </h2>
            </div>
            <p className="page-caption12">
              <span className="page-text047">
              ...
              <br className="page-text048"></br>
              <br className="page-text049"></br>
              <span className="page-text050">
                *refund amount is noted on the contract.
              </span>
              <br className="page-text051"></br>
              <br className="page-text052"></br>
              <br className="page-text053"></br>
            </p>
          </div>
          <div className="page-testimonial">
            <div className="page-content07">
              <span className="page-text054">Testimonial</span>
              <p className="page-text055">
            ...
            <div className="page-information">
              <div className="page-author">
                <img
                  ...
                  className="page-icon31"
                />
                <span className="page-name">Tea Visan</span>
              </div>
              <a
        ...
        <div className="page-images">
          ...
          <img
            ...
            className="page-image08"
          />
        </div>
      </section>
      <section className="page-experience">
        <div className="page-images1">
          <div className="page-square1"></div>
          <img
            alt="image"
            src="https://i.imgur.com/p0gMEgQ.jpg"
            className="page-image09"
          />
        </div>
        <div className="page-content08">
          <div className="page-header13">
            <div className="page-header-container2">
              <div className="page-header14">
                <h2 className="page-heading09">
                  A trusted service every time.
                </h2>
              </div>
              <p className="page-caption13">
            ...
            <div className="page-checkmarks">
              <div className="page-check">
                <div className="page-mark">
                  <svg viewBox="0 0 1024 1024" className="page-icon32">
                    <path d="M823.168 225.835l-439.168 439.168-183.168-183.168c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331l213.333 213.333c16.683 16.683 43.691 16.683 60.331 0l469.333-469.333c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0z"></path>
                  </svg>
                </div>
                <span className="page-text056">
                  Duis aute irure dolor in reprehenderit
                </span>
              </div>
              <div className="page-check1">
                <div className="page-mark1">
                  <svg viewBox="0 0 1024 1024" className="page-icon34">
                    <path d="M823.168 225.835l-439.168 439.168-183.168-183.168c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331l213.333 213.333c16.683 16.683 43.691 16.683 60.331 0l469.333-469.333c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0z"></path>
                  </svg>
                </div>
                <span className="page-text057">Lorem ipsum dolor sit amet</span>
              </div>
              <div className="page-check2">
                <div className="page-mark2">
                  <svg viewBox="0 0 1024 1024" className="page-icon36">
                    <path d="M823.168 225.835l-439.168 439.168-183.168-183.168c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331l213.333 213.333c16.683 16.683 43.691 16.683 60.331 0l469.333-469.333c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0z"></path>
                  </svg>
                </div>
                <span className="page-text058">
                  Voluptate velit esse cillum dolore eu fugiat nulla
                </span>
              </div>
              <div className="page-check3">
                <div className="page-mark3">
                  <svg viewBox="0 0 1024 1024" className="page-icon38">
                    <path d="M823.168 225.835l-439.168 439.168-183.168-183.168c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331l213.333 213.333c16.683 16.683 43.691 16.683 60.331 0l469.333-469.333c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0z"></path>
                  </svg>
                </div>
                <span className="page-text059">
                  Excepteur sint occaecat cupidatat non proident sunt in culpa
                </span>
              </div>
            </div>
          </div>
          <div className="page-testimonial1">
            <div className="page-content09">
              <span className="page-text060">Testimonial</span>
              <p className="page-text061">
            ...
            <div className="page-information1">
              <div className="page-author1">
                <span className="page-name1">George </span>
              </div>
              <a
      ...
      <section className="page-create">
        <div className="page-content10">
          <div className="page-header15">
            <h2 className="page-heading10">
              <span>Outstanding </span>
              <span className="page-text063">visual content!</span>
              <span>
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
          ...
          <button className="page-button3 button">
            <span>
      ...
      <section className="page-comparision">
        <div className="page-header-container3">
          <div className="page-header16">
            <h2 className="page-heading11">
              <span>Packages we offer</span>
              <br></br>
            </h2>
          </div>
          <p className="page-caption14">
        ...
        <div className="page-table">
          <div className="page-row">
            <div className="page-headers">
              <span className="page-text071">Placeholder</span>
            </div>
            <div className="page-plans">
              <div className="page-row01">
                <span className="page-text072">TOGHTR</span>
                <span className="page-text073">AGENCY</span>
                <span className="page-text074">FRELLANCE</span>
              </div>
            </div>
          </div>
          <div className="page-row02">
            <div className="page-headers1">
              <span className="page-text075">
                Duis aute irure dolor in reprehenderit
              </span>
            </div>
            <div className="page-plans1">
              <div className="page-row03">
                <div className="value">
                  <Check></Check>
                </div>
                <div className="value">
          ...
          <div className="page-row04">
            <div className="page-headers2">
              <span className="page-text076">Lorem ipsum dolor sit amet</span>
            </div>
            <div className="page-plans2">
              <div className="page-row05">
                <div className="value">
                  <Check></Check>
                </div>
                <div className="value">
          ...
          <div className="page-row06">
            <div className="page-headers3">
              <span className="page-text077">
                Duis aute irure dolor in reprehenderit
              </span>
            </div>
            <div className="page-plans3">
              <div className="page-row07">
                <div className="value">
                  <span className="page-text078">Custom</span>
                </div>
                <div className="value">
                  <Line></Line>
                </div>
          ...
          <div className="page-row08">
            <div className="page-headers4">
              <span className="page-text079">
                Duis aute irure dolor in reprehenderit
              </span>
            </div>
            <div className="page-plans4">
              <div className="page-row09">
                <div className="value">
                  <span className="page-text080">Unlimited</span>
                </div>
                <div className="value">
                  <span className="page-text081">Limited</span>
                </div>
                <div className="value">
                  <Line></Line>
                </div>
          ...
          <div className="page-row10">
            <div className="page-headers5">
              <span className="page-text082">Lorem ipsum dolor sit amet</span>
            </div>
            <div className="page-plans5">
              <div className="page-row11">
                <div className="value">
                  <Check></Check>
                </div>
                <div className="value">
                ...
                <div className="value">
                  <span className="page-text083">Limited</span>
                </div>
              </div>
            </div>
          </div>
          <div className="page-row12">
            <div className="page-headers6">
              <span className="page-text084">Lorem ipsum dolor sit amet</span>
            </div>
            <div className="page-plans6">
              <div className="page-row13">
                <div className="value">
                  <Check></Check>
                </div>
                <div className="value">
          ...
          <div className="page-row14">
            <div className="page-headers7">
              <span className="page-text085">Lorem ipsum dolor sit amet</span>
            </div>
            <div className="page-plans7">
              <div className="page-row15">
                <div className="value">
                  <Check></Check>
                </div>
                <div className="value">
                  <span className="page-text086">Limited</span>
                </div>
                <div className="value">
                  <Line></Line>
                </div>
      ...
      <section className="page-data">
        <div className="page-header-container4">
          <div className="page-header17">
            <div className="page-row16">
              <h2 className="page-heading12">
                <span>
          ...
          <p className="page-caption15">
            <span className="page-text089">
            ...
            <br className="page-text090"></br>
            <br className="page-text091"></br>
            <span className="page-text092">
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
                }}
        ...
        <div className="page-content11">
          <div className="page-image10">
            <img
              alt="image"
          ...
          <div className="page-accordion">
            <div data-role="accordion-container" className="accordion">
              <div>
                <h3 className="page-header18">Our studio</h3>
            ...
            <div data-role="accordion-container" className="accordion">
              <div>
                <h3 className="page-header19">Our prices</h3>
                <p data-role="accordion-content" className="accordion-content">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
            ...
            <div data-role="accordion-container" className="accordion">
              <div>
                <h3 className="page-header20">Photography</h3>
                <p data-role="accordion-content" className="accordion-content">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
            ...
            <div data-role="accordion-container" className="accordion">
              <div>
                <h3 className="page-header21">Promotional videos</h3>
                <p data-role="accordion-content" className="accordion-content">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
...
`}
      ...
      <section className="page-customer">
        <div className="page-header22"></div>
        <div className="page-quotes">
          <div className="page-quote">
            <p className="page-quote1">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            ...
            <div className="page-author2">
              <span className="page-name2">Joanna Smith</span>
              <span className="page-location">Briville</span>
            </div>
          </div>
          <div className="page-quote2">
            <p className="page-quote3">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div className="page-author3">
              <span className="page-name3">Joanna Smith</span>
              <span className="page-location1">Briville</span>
            </div>
          </div>
          <div className="page-quote4">
            <p className="page-quote5">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div className="page-author4">
              <span className="page-name4">Joanna Smith</span>
              <span className="page-location2">Briville</span>
            </div>
          </div>
          <div className="page-quote6">
            <p className="page-quote7">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div className="page-author5">
              <span className="page-name5">Joanna Smith</span>
              <span className="page-location3">Briville</span>
            </div>
          </div>
        </div>
        <div className="page-controls1">
          <button className="page-previous1 button">
            <svg viewBox="0 0 1024 1024" className="page-icon40">
              <path d="M542.165 780.501l-225.835-225.835h494.336c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-494.336l225.835-225.835c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0l-298.667 298.667c-4.096 4.096-7.168 8.789-9.259 13.824-2.176 5.205-3.243 10.795-3.243 16.341 0 10.923 4.181 21.845 12.501 30.165l298.667 298.667c16.683 16.683 43.691 16.683 60.331 0s16.683-43.691 0-60.331z"></path>
            </svg>
          </button>
          <button className="page-next1 button">
            <svg viewBox="0 0 1024 1024" className="page-icon42">
              <path d="M481.835 243.499l225.835 225.835h-494.336c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667h494.336l-225.835 225.835c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0l298.667-298.667c3.925-3.925 7.083-8.619 9.259-13.824 4.309-10.453 4.309-22.229 0-32.683-2.091-5.035-5.163-9.728-9.259-13.824l-298.667-298.667c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331z"></path>
            </svg>
          </button>
          <button className="button page-button4">
            <span>
      ...
      <section className="page-faq">
        <div className="page-header23">
          <h2 className="page-heading13">
            ...
            <span className="page-text097">questions</span>
            <span>
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
        ...
        <div className="page-content20">
          <div className="page-column">
            <div className="page-element04">
              <h3 className="page-header24">
                Lorem ipsum dolor sit ametetur elit?
              </h3>
              <p className="page-content21">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            ...
            <div className="page-element05">
              <h3 className="page-header25">
                Excepteur sint occaecat cupidatat non sunt in culpa qui officia
                deserunt mollit anim id est laborum?
              </h3>
              <p className="page-content22">
            ...
            <div className="page-element06">
              <h3 className="page-header26">
                Tempor incididunt ut labore et dolore magna aliquat enim ad
                minim?
              </h3>
              <p className="page-content23">
          ...
          <div className="page-column1">
            <div className="page-element07">
              <h3 className="page-header27">
                Tempor incididunt ut labore et dolore magna aliquat enim ad
                minim?
              </h3>
              <p className="page-content24">
                Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                commodo consequat. Duis aute irure dolor in reprehenderit in
                voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                Excepteur sint occaecat cupidatat non proident, sunt in culpa
            ...
            <div className="page-element08">
              <h3 className="page-header28">
                Lorem ipsum dolor sit ametetur elit?
              </h3>
              <p className="page-content25">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua.
                <span
                  dangerouslySetInnerHTML={{
            ...
            <div className="page-element09">
              <h3 className="page-header29">Incididunt ut labore et dolore?</h3>
              <p className="page-content26">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua.
                <span
                  dangerouslySetInnerHTML={{
      ...
      <div className="page-feature-card">
        <svg viewBox="0 0 1024 1024" className="page-icon44">
        ...
        <h2 className="page-text099">
          Oops! Looks like you&apos;ve stumbled upon a page that doesn&apos;t
          exist.
        </h2>
        <span className="page-text100">
          {' '}
          Did you mistype the URL, or did the page decide to take a day off? We
          may never know. But don&apos;t worry, we won&apos;t hold it against
          you. It&apos;s not like you spilled coffee on our keyboard (again).
        </span>
        <Link to="/" className="page-navlink button">
          Home
        </Link>
        <span className="page-text101">SEE MORE</span>
      </div>
            ...
            <div className="page-links">
              <div className="page-column2">
                ...
                <div className="page-list">
                  ...
                  <Link to="/" className="page-navlink05">
                    <span className="page-text103">Why</span>
                    <br></br>
                  </Link>
                </div>
              </div>
              ...
              <div className="page-column4">
                ...
                <div className="page-list2">
                  ...
                  <Link to="/" className="page-navlink17">
                    TikTok
                  </Link>
                </div>
              </div>
